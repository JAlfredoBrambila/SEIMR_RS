...
public class JFrameSimulador extends javax.swing.JFrame {
	...
	this.jComboBoxEstrato.addItem("Todos los segmentos");
    ...
    private void initComponents() {
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/support/img/gear-icon.png"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        JFrameParametrosMovilidad m = new JFrameParametrosMovilidad(this);
        //m.llenaTablas();
        m.setVisible(true);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
	JFrameOptParams frame = new JFrameOptParams(this);
	frame.setVisible(true);
    }//GEN-LAST:event_jButton2ActionPerformed

    public void setParamsOPT(double MIUUB, double ETAXB2, double DELXB2, double PHIXB3, double ETAXB3, double DELXB3) {
	this.jTextFieldMIUUB.setText(MIUUB+"");
	this.jTextFieldETHA2.setText(ETAXB2+"");
	this.jTextFieldDelta2.setText(DELXB2+"");
	this.jTextFieldPHIX3.setText(PHIXB3+"");
	this.jTextFieldETHA3.setText(ETAXB3+"");
	this.jTextFieldDelta3.setText(DELXB3+"");
    }
